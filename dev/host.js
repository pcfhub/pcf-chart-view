...
(function (root, factory) {
    ...
    var STRINGS = {
        ChartView_Name: "Chart View",
        ChartView_Desc: "A Dataverse view as a bar, column, pie, donut or line chart — grouped by a column, aggregated on the server.",
        ChartView_Loading: "Loading…",
        ChartView_Empty: "No records to chart.",
        ChartView_NoCategory: "Choose a column to group by.",
        ChartView_Error: "The records could not be loaded.",
        ChartView_Other: "Other",
        ...
        ChartView_Measure_Avg: "Average {0}",
        ChartView_Measure_Min: "Smallest {0}",
        ChartView_Measure_Max: "Largest {0}",
        ChartView_Percent: "{0}%",
        ChartView_ItemLabel: "{0}: {1} ({2}%)",
        ChartView_Selected: "Selected",
        ChartView_Table: "Chart data",
        ChartView_Week: "W{0} {1}",
        ChartView_Quarter: "Q{0} {1}",
        ChartView_Chart: "{0} chart",
    };
